        ...
        <ul className="flex justify-between items-center">
          ...
          >
            ...
            <div ref={accountRef} className="relative">
              ...
              >
                {userDp ? (
                  <img src={`${API_BASE_URL}/uploads/${userDp}`} alt="userDp" />
                ) : (
              ...
              <div
                className={`${
                  isAccountMenu ? "flex flex-col" : "hidden"
                } absolute py-2 bottom rounded-lg w-[300px] right-[-50%] top-12 shadow-2xl  bg-gray-300 max-md:w-[200px]`}
              >
                <div
                  onClick={handleLogout}
                  className="px-2 cursor-pointer h-12 flex items-center border-b border-b-gray-400 hover:bg-gray-200"
                >
                  <div className="text-nowrap">Log out</div>
                </div>
                <div onClick={()=>{navigate('/manage-account'); setIsAccountMenu(false)}} className="text-nowrap h-12 flex items-center px-2 cursor-pointer hover:bg-gray-200">
                  Manage your account
                </div>
              </div>
            </div>
